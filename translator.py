...
def MakeStrings(dic,locs):
  ...
  for lang in locs:
    lang2 = lang
    if lang == 'en': lang2 = 'English'
    lproj = 'IPAServer/%s.lproj' % (lang2)
...
if __name__ == '__main__':
  ...
  warnOpt = False
  shortopts = "hpst:vw"
  longopts = ["html","strings","template:","verbose","warnings"]
  try:
  ...
  for item in items:
    ...
    ipadat = dict()
    for line in lines:
      (label,data) = re.split(r':\s*',line,1)
      if label == 'Glyph': ipa = data
